view: WF_Order_Volume_Summary_Monthly_test {
  ...
  Select
   ...
   --     D.orderId,
    ...
    --O.requestAction,
    --O.Updated_date,
    FORMAT_DATE("%b %Y", O.Month_Date ) as Month_Date,
 --   O.Month_Date,
    O.Measure
    ,
    -- O.completed_status,
 ...
 ;;  # Select
    ...
    # originationSystemName,
    # serviceType,
    # FORMAT_DATE("%b %Y", Month_Date ) as Month_Date,
